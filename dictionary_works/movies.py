...
# q1 : print the movies on yearly basis as a dictionary,
...
# q2 : print thriller movies

# for movie in movies:
#     if "Thriller" in movie.get("genres"):
#         print(movie.get("title"))

# q3 : find the director of the film "To Kill a mocking bird"

# for movie in movies:
#     if movie.get("title")=="To Kill a Mockingbird":
#         print(movie.get("director"))

# q4 : print the movies that Ryan gosling acted

# for movie in movies:
#     if "Ryan Gosling" in movie.get("actors"):
#         print(movie.get("title"))

# q5 : print a dictionary that includes movies and genres

# genres_movies={}
# for movie in movies:
#     genre=movie.get("genres")
#     for gen in genre:
#         if gen in genres_movies:
#             genres_movies[gen]+=1
#         else:
#             genres_movies[gen]=1
# print(genres_movies)

# max=max(genres_movies,key=lambda x:genres_movies.get(x))
# print(max)

# value=genres_movies.values()
# print(sum(value))

# q6 :total length of movies
...
# for movie in movies:
#     run_time= int(movie.get("runtime"))
#     if run_time>150:    
#         print(movie.get("title"))

# q8 :highest runtime movie
...
# user_input=int(input("enter the id of the movie : "))

# for movie in movies:
#     id_movie=movie.get("id")
#     if user_input==id_movie:
#         print(movie.get("title"))

# q10 : movie : Action and Drama

# action_drama=[movie.get("title") for movie in movies if "Action" in movie.get("genres") and "Drama" in movie.get("genres")]
# print(action_drama)

# q11: which genres more movie

genre_count={}
for movie in movies:
    genres_movies=movie.get("genres")
...
max_genre=max(genre_count,key=lambda x:genre_count.get(x))
print(max_genre)

# max_genre=[(v,k) for k,v in max_count.items()]
# print(max(max_genre))
